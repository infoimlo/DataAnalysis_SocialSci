...
#Generating 1000 samples of size n - Option A  -NOT IT
...
theta <- 5        # MAYBE IT???   - NOT IT CUS THE PROBABLITY DOESN'T END UP CLOSE TO 0.9
#sample size
n <- 25
#Generating 1000 samples of size n - original
simul <- 1000
...
# Option C -> mean = 0.912; 0.919; 0.903    # MAYBE IT?!?  - CORRECT BECAUSE THE PROBABABILTY ROUNDS CLOSEST TO P(...) = 0.9
#Real value of theta
theta <- 5
#sample size
n <- 25
...
# Option D -> mean(thetain)   # DEF NOT IT!!
#Real value of theta
theta <- 5
#sample size
n <- 25
